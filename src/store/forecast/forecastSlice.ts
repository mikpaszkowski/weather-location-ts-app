...
import weatherService, { IForecastResponse } from "../../services/api/wetherAPI";
...
export const fetchForecast = createAsyncThunk<IForecast,
  string,
  {
...
export const selectDailyForecast = (state: RootState) => state.forecast.forecast.daily;
export const selectHourlyForecast = (state: RootState) => state.forecast.forecast.hourly;
